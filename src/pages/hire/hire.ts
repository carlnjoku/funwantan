...
export class Hire {
  ...
  myForm: FormGroup;
  postInfo: any = {userID:this.userID, itemID: this.itemID, title: this.title, iphoto: this.iphoto, adminID: this.adminID, brandID: this.brandID, sale_price:this.sale_price, order_type:this.order_type, size:''};
